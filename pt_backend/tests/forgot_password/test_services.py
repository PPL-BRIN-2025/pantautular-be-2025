...
from pt_backend.services import PasswordResetService
...
class TestPasswordResetService(TestCase):
    ...
    def test_create_reset_link_successful(self):
        ...
        self.assertTrue(link.startswith("http://localhost:3000/reset-password/"))
    ...
    def test_special_chars_in_url(self):
        ...
        service = PasswordResetService(reset_url_base="http://localhost:3000/reset-password?special=!@#$%^&*()")
